...
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Introduction to the CLIC package}
...
The script used for computing CLIC scores is available [here](https://github.com/oldvalley49/CLIC_compute)
